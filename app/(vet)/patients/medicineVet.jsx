import { StyleSheet, TouchableWithoutFeedback, FlatList, View, useColorScheme, Text } from 'react-native'
    ...
    <TouchableWithoutFeedback>
      <ThemedView style={styles.container} safe={true}>
        ...
        <FlatList
          ...
          ListEmptyComponent={<ThemedText style={{ textAlign: 'center', opacity: 0.6 }}>No current medicines.</ThemedText>}
        ...
        <FlatList
          ...
          keyExtractor={(item) => item.$id}
          renderItem={renderItem}
          ListEmptyComponent={<ThemedText style={{ textAlign: 'center', opacity: 0.6 }}>No past medicines.</ThemedText>}
          contentContainerStyle={{ paddingBottom: 20 }}
        />

        <ThemedButton onPress={() => router.push({ pathname: `/patients/addMedicine`, params: { patient: pet.$id } })} style={styles.button}>
...
export default MedicineVet

const styles = StyleSheet.create({
  container: { flex: 1 },
  heading: { fontWeight: 'bold', fontSize: 30, textAlign: 'center', marginTop: 40, color: Colors.primary },
  list: { marginTop: 20 },
  card: { width: '90%', marginHorizontal: '5%', marginVertical: 10, padding: 10, paddingLeft: 14, borderLeftColor: Colors.primary, borderLeftWidth: 4, borderRadius: 15 },
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 6 },
  section: { marginTop: 10, marginLeft: 20, fontSize: 18, color: Colors.primary },
  button: { marginTop: 20, backgroundColor: Colors.primary, width: '50%', alignSelf: 'center', alignItems: 'center' },
  cancel: { marginTop: 20, backgroundColor: Colors.warning, width: '50%', alignSelf: 'center', alignItems: 'center' },
})
